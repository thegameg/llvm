...
DependenceInfo::depends(Instruction *Src, Instruction *Dst,
  ...
  if (Coupled.count()) {
    ...
    for (int SI : Coupled.bit_set()) {
      ...
      DEBUG(dbgs() << "    updating\n");
      for (int SJ : ConstrainedLevels.bit_set()) {
